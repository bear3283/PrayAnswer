...
enum L {
    ...
    enum Settings {
        ...
        static let onDeviceRecognition = NSLocalizedString("settings.on_device_recognition", value: "기기 내 음성 인식", comment: "On-device speech recognition toggle")
        static let onDeviceRecognitionDesc = NSLocalizedString("settings.on_device_recognition_desc", value: "음성 데이터를 서버로 보내지 않습니다. 오프라인 사용 가능하며, 개인정보가 보호됩니다.", comment: "On-device recognition description")
        static let autoPunctuation = NSLocalizedString("settings.auto_punctuation", value: "자동 문장 부호", comment: "Auto punctuation toggle")
        static let autoPunctuationDesc = NSLocalizedString("settings.auto_punctuation_desc", value: "음성 인식 결과에 마침표·쉼표를 자동으로 추가합니다.", comment: "Auto punctuation description")
